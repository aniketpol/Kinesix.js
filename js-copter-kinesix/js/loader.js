	...
	var $tCanvas = document.getElementById('kinesixcanvas');
...
function startVideo() {
		...
		var callback2 =function (coords,context)
		{
			...
			if (coords[0]){
					...
					/*var div=document.getElementById("list");
						...
						div.innerHTML+="y  "+y;
						div.innerHTML+="<br>";
						div.innerHTML+="width  "+ width;
						div.innerHTML+="<br>";
						div.innerHTML+="height  " + height;
						div.innerHTML+="<br>";
						div.innerHTML+=width+x;
						div.innerHTML+="<br>";
						div.innerHTML+=height+20;
						div.innerHTML+="<br>";*/
