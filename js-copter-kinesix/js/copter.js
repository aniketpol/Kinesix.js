...
var jsCopter = {
    ...
    options : {
        ...
        copter : {
            width : 30,
            height : 15,
            topSpeed : 6,                   // max speed
            acceleration : 0.5,            // how much to increase the speed by each time the game refreshes and the button is held down
	...
	kinesixEventHandler : function (posture)
	{
		//console.log("EVENT!!!!!!!!!!======== " + posture);
